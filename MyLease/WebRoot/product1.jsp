																				...
																				<ul>
																					<li id="menua">
																						...
																						<ul class="block_box">
																							...
																							<li><a href="">吊车</a></li>
																							<li><a href="">发电机</a></li>
																							<li><a href="">挖掘装载机械</a></li>
																							<li><a href="">混凝土施工机械</a></li>
																							<li><a href="">更多>></a></li>
							...
							<div class="content-product-right col-sm-6 col-xs-12">
								...
								<div class="product-label form-group">
									<div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
										<span class="price-new" itemprop="price">$<%=rs.getInt("goods_price") %>元/天</span>
									</div>
